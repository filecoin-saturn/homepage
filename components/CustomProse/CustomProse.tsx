...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            prose-h1:font-inter prose-h1:font-semibold prose-h1:text-[1.75rem] prose-h1:lg:text-4xl prose-h1:md:mb-2 prose-h1:mb-1.5
            prose-h2:font-inter prose-h2:font-semibold prose-h2:text-2xl prose-h2:sm:text-2xl
            ...
            prose-ul:list-none prose-ul:font-source-serif-pro prose-ul:text-base prose-ul:font-normal prose-ul:sm:text-lg prose-ul:text-black
