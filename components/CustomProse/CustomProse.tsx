...
export default function CustomProse({children, overrides, overridesParent}: Props) {
    return (
        <div className={`prose antialiased ${overridesParent ?? ""}
            ...
            prose-strong:font-inter prose-strong:text-white prose-strong:text-xs prose-strong:md:text-base prose-strong:lg:text-lg prose-strong:font-semibold prose-strong:leading-5 prose-strong:lg:leading-6
