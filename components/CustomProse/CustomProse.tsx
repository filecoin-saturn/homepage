...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            ...
            prose-h4:font-inter prose-h4:font-normal prose-h4:text-white prose-h4:mb-2 prose-h4:text-lg prose-h4:md:text-xl prose-h4:lg:text-xl prose-h4:tracking-wide
