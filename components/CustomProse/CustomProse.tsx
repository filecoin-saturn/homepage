...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            ...
            prose-h3:font-inter prose-h3:font-black prose-h3:text-white prose-h3:mb-1  prose-h3:text-2xl prose-h3:lg:text-[1.7rem] prose-h3:leading-tight
            prose-h4:font-inter prose-h4:font-semibold prose-h4:text-white prose-h4:mb-2 prose-h4:text-2xl prose-h4:md:text-2xl prose-h4:lg:text-3xl
            prose-h5:font-inter prose-h5:font-black prose-h5:text-white prose-h5:mb-2 prose-h5:text-lg prose-h5:md:text-xl prose-h5:lg:text-3xl
            prose-h6:font-inter prose-h6:font-regular prose-h6:text-white prose-h6:mb-2 prose-h6:text-lg prose-h6:md:text-xl prose-h6:lg:text-base
