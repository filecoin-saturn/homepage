...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            prose-h1:font-inter prose-h1:font-semibold prose-h1:text-[1.75rem] prose-h1:lg:text-4xl prose-h1:xl:text-[2.35rem] prose-h1:md:mb-4 prose-h1:mb-1.5 prose-h1:underline-offset-4
            ...
            prose-hr:mx-auto prose-hr:w-1/6 prose-hr:my-4 prose-hr:h-[0.15rem] prose-hr:bg-gradient-to-r prose-hr:from-gradient-turqouise prose-hr:to-gradient-blue
