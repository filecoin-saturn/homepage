...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            ...
            prose-h4:font-inter prose-h4:font-black prose-h4:text-white prose-h4:my-2 prose-h4:text-2xl prose-h4:md:text-3xl prose-h4:lg:text-3xl
            prose-h5:font-inter prose-h5:font-black prose-h5:text-white prose-h5:my-2 prose-h5:text-xl prose-h5:md:text-2xl prose-h5:lg:text-2xl
            prose-p:font-inter prose-p:text-white prose-p:text-sm prose-p:md:text-base prose-p:lg:text-lg prose-p:font-normal 
