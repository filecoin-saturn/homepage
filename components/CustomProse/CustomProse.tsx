...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            ...
            prose-h3:font-inter prose-h3:font-black 
            prose-h4:font-inter prose-h4:font-semibold prose-h4:text-sat-grey-2 prose-h4:my-2 prose-h4:text-base prose-h4:md:text-lg prose-h4:lg:text-2xl prose-h4:tracking-wide
