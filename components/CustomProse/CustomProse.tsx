...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            ...
            prose-h5:font-inter prose-h5:font-black prose-h5:text-white prose-h5:my-2 prose-h5:text-xl prose-h5:md:text-2xl prose-h5:lg:text-2xl prose-h5:lg:leading-7
