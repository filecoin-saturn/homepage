...
export default function CustomProse({children, overrides}: Props) {
    return (
        <div className="prose antialiased
            prose-h1:font-inter prose-h1:font-black prose-h1:my-4 prose-h1:text-white prose-h1:text-5xl prose-h1:md:text-6xl prose-h1:lg:text-7xl
            prose-h2:font-inter prose-h2:font-semibold prose-h2:text-2xl prose-h2:lg:text-3xl prose-h2:text-white prose-h2:my-4
            ...
            prose-h4:font-inter prose-h4:font-semibold prose-h4:text-white prose-h4:mt-2 prose-h4:md:mb-8 prose-h4:mb-2 prose-h4:text-lg prose-h4:md:text-xl prose-h4:lg:text-2xl prose-h4:tracking-wide
