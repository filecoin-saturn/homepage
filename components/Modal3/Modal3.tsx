...
export default function Modal3({children, backdropBlur, link, contentId}: Props) {
    ...
    return (
        <div className="relative -mx-2">
            <a target="_blank" data-analytics={`${a}`} rel="noreferrer" href={l} className={`flex overflow-hidden items-center justify-between focus-visible:delay-0 focus-visible:transition-none font-inter opacity-100 outline-transparent outline-none ring-inset ring-transparent ring-2 md:ring-[0.1875rem] focus-visible:ring-white rounded-[1.4375rem] md:rounded-[1.75rem] lg:rounded-[2.0625rem] group pl-[1.375rem] md:pl-[1.625rem] pr-[0.3125rem] md:pr-1.5 py-[0.3125rem] md:py-1.5 lg:py-2 lg:pr-2 lg:pl-[2.375rem] space-x-4  active:scale-90 transition-transform ${backdropBlur ? `supports-blur:backdrop-blur-sm supports-blur:bg-sat-grad-blue-green-1-20 supports-blur:hover:bg-sat-grad-blue-green-1-30 bg-sat-grad-blue-green-1-10-fallback-1 hover:bg-sat-grad-blue-green-1-30-fallback-2 supports-blur:active:bg-sat-grad-blue-green-1-40 `: `bg-sat-grad-blue-green-1-10-fallback-1 hover:bg-sat-grad-blue-green-1-30-fallback-2`}`}>
