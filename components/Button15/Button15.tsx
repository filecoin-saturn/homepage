...
function Button15({ backdropBlur, contentId, text, link, backgroundImage}: Props) {
    ...
    return (
        <Link href={l}>
            <a target="_blank" className="outline-none group " >
                <div className={`flex items-center space-x-2 rounded-full p-1 px-3 border-2 border-transparent group-focus-visible:border-white group-active:scale-90 will-change-transform ${backdropBlur ? `supports-blur:group-focus-visible:bg-sat-grad-blue-green-1-20 supports-blur:group-hover:bg-sat-grad-blue-green-1-30 supports-blur:group-active:bg-sat-grad-blue-green-1-40 supports-blur:bg-sat-grad-blue-green-1-20 supports-blur:backdrop-blur-md bg-sat-grad-blue-green-1-40-fallback-1 group-hover:bg-sat-grad-blue-green-1-30-fallback-1 group-active:bg-sat-grad-blue-green-1-40-fallback-1 group-focus-visible:bg-sat-grad-blue-green-1-20-fallback-1` : `bg-sat-white-10-fallback-2 group-hover:bg-sat-grad-blue-green-1-30-fallback-1 group-active:bg-sat-grad-blue-green-1-40-fallback-1 group-focus-visible:bg-sat-grad-blue-green-1-20-fallback-1`} `}>
