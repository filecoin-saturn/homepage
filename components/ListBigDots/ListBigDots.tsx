                ...
                return (
                    <div key={i} className='flex space-x-1 md:space-x-3'>
                        <div className='flex flex-col'>
                            <div className={`${backdropBlur ? ` supports-blur:backdrop-blur-md supports-blur:outline-sat-blue-3/30` : ``} outline-sat-blue-3-30-fallback-1 bg-sat-blue-3 outline-4 outline rounded-full min-w-[1.2rem] min-h-[1.2rem] `}/>
