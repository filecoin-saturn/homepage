    ...
    return (
        <Link href={link}>
            <a href="" target="_blank" className="outline-none group " >
                <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-md rounded-full p-1 px-3 border-2 border-transparent group-focus-visible:border-white group-hover:bg-white/25 group-active:bg-white/40 group-active:scale-90 ">
