...
export default function Button2({text, link, disabled, backdropBlur, target}: Props) {
    return (
            <a target={target} href={link} className={`${disabled ? `pointer-events-none ` : ``} group outline-none relative `}>
