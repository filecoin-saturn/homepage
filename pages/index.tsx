  ...
  return (
    <>
      ...
      <div className='mx-auto w-full overflow-hidden relative'>
        ...
        <NavBar languageSwitcher={false} backdropBlur={features.backdropBlur} sections={["start", "calculateearnings" ,"whatissaturn", "ourvision", "roadmap", "setupyournode", "faq", "careers", "contact"]} contentId="general.navbar" />
