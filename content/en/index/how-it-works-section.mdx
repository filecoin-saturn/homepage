...
- Network edge nodes (<b>L1</b>s): High bandwidth servers with large caches close to users.
- Intermediate cache nodes (<b>L2</b>s): Desktops running Windows, Linux, and OS X and smaller servers.
