...
export const studies = [
    {title:"Amazon", subtitle:"1% loss of sales for every additional 100ms load time", link: "/", logo: "amazon-logo.svg"},
    {title:"Walmart", subtitle:"+2% conversion for every 1s load time improvement", link: "/", logo: "walmart-logo.svg"}
]
