...
export const ctas = [
    {subtext:"Become a node operator:", text: "Setup & Earn (5 mins)", link: "#setupyournode"},
]

{/* c:metrics */}

export const metrics = [
    {metric:"Points of presence (POPs)", number: "65", unit: ""},
    {metric:"Requests served each day", number: "140", unit: "M"},
    // {metric:"Global network uplink capacity", number: "155", unit: "TBit /s"}
...
- **<span className="font-black">Dedicated</span> server with a public IPv4 address**
- **Ports 80 and 443 free**
- **User with sudo privileges**
- <a target="_blank" href="https://docs.filecoin.io/reference/overview/#wallets-audited">FIL Wallet</a>
