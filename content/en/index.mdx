...
export const metrics = [
    {metric:"Points of\nPresence (PoPs)", number: "65", unit: ""},
    {metric:"Requests served each day", number: "140", unit: "M"},
...
Have a server? Enter your server's upload speed and available storage below to estimate how much money you can make monthly.
	
Saturn is growing rapidly. <b>The earlier you join, the more you’ll earn.</b>
...
export const content = [
    {
        ...
        text: "Anyone can join. Saturn is a united network of the world’s hardware — from servers in data centers to end user desktops and phones.",
    },
    {
        image: "lightning-logo.svg",
        title: "Democratize Delivery",
        text: "Everyone can contribute to the network and earn Filecoin, wherever they are. Earnings are shared by the community, not a company.",
    },
    {
...
Earn filecoin by contributing server resources - <strong>Serve more, earn more!</strong>
...
- **10Gbps upload** <span className="small-p">(4TB+ SSD recommended)</span>
...
Saturn nodes are neatly packaged Docker containers. Set up your node in no time with <a href="https://www.docker.com/" target="_blank">Docker</a> or with our easy-to-use <a href="https://www.ansible.com/" target="_blank">Ansible</a> playbook.
