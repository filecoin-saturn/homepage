...
Filecoin Saturn is an open-source, decentralized Content Delivery Network built on Filecoin. Run a node, join the network, and earn Filecoin for accelerating the distribute web.
...
export const metrics = [
    {metric:"Points of\npresence", number: "65", unit: ""},
    {metric:"Requests served each day", number: "240.3", unit: "M"},
    {metric:"Global network uplink capacity", number: "155", unit: "TBit /s"}

]

{/* c:estimateyourearnings.title */}

# Estimate your earnings

{/* c:estimateyourearnings.description */}
...
{/* c:estimateyourearnings.footnote */}
...
Are you interested in joining the Filecoin Saturn network or have questions about how to use our decentralized CDN? Let’s talk!
